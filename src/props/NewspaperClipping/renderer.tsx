        ...
        <div className="space-y-8">
          <Markdown
            className={classNames(
              "block font-serif text-justify copy-markdown prose clipping-markdown",
              {
          ...
          <Markdown className="block font-serif text-justify prose copy-markdown clipping-markdown">
            {props.main_copy}
          </Markdown>
          <Markdown
            className={classNames(
